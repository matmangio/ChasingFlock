...
<figure>
	<a name="figure3"></a>
	<img src="assets/Neighbourhood.png" height="350px" alt="Boid neighbourhood">
...
<figure>
	<a name="figure4"></a>
	<img src="assets/Weights.png" height="350px" alt="Flocking components weights">
...
<figure>
	<a name="figure5"></a>
	<img src="assets/Vertical.png" height="350px" alt="Vertical range representation">
...
<figure>
	<a name="figure6"></a>
	<img src="assets/Wall.png" height="280px" alt="Representation of wall avoidance">
...
<a name="figure7"></a>
@startuml
abstract SteeringBehaviour {
	+ Priority : int
	{abstract} + GetDirection() : Vector3
	{abstract} # Init() : void
	- Awake() : void
}
abstract BoidComponent {}
...
class AvoidWalls {}
SteeringBehaviour <|.. BoidComponent
SteeringBehaviour <|-- AvoidObstacles
SteeringBehaviour <|-- AvoidWalls
SteeringBehaviour <|-- ChaseTarget
BoidComponent <|-- BoidSeparation
BoidComponent <|-- BoidCohesion
BoidComponent <|-- BoidAlignment
@enduml
